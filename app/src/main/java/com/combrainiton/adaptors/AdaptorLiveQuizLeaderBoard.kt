 ...
 */
class AdaptorLiveQuizLeaderBoard(var mContext: Context, var mActivity: Activity, private var userList: ArrayList<SingleQuestionLeaderBoardResponceModel.UserList>, private var userPosition: Int) : androidx.recyclerview.widget.RecyclerView.Adapter<AdaptorLiveQuizLeaderBoard.MyViewHolder>() {
